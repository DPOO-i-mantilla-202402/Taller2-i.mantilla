...
public class SandboxConjuntos
{
    ...
    {
    	List<String> nuevaList = new ArrayList<String>(this.arbolCadenas);   
    ...
    {
    	List<String> nuevaList = getCadenasComoLista();
        
    	nuevaList.sort(String::compareTo);

        List<String> nuevaListInvertida = new ArrayList<>();
        
        Iterator<String> iterador = nuevaList.iterator();
        while (iterador.hasNext()) {
            String valor = iterador.next();
            nuevaListInvertida.add(0, valor); // Añadir al principio para mantener el orden inverso
        }
        
        return nuevaListInvertida;
    }
    ...
    public Collection<String> getSiguientes( String cadena )
    {
        ...
        Iterator<String> iterador = this.arbolCadenas.tailSet(cadena, true).iterator();
        
        while (iterador.hasNext()) {
            coleccion.add(iterador.next());
        }
    ...
    {
    	int cantidadCadenas = this.arbolCadenas.size();
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
        ...
        this.arbolCadenas = nuevoConjunto;
    }
    ...
    public void volverMayusculas( )
    {
        ...
        while (iterador.hasNext()) {
            nuevoConjunto.add(iterador.next().toUpperCase());
        }
        this.arbolCadenas = nuevoConjunto;
    }
    ...
    {
    	TreeSet<String> arbol = new TreeSet<>(this.arbolCadenas.descendingSet());
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        while (iterador.hasNext()) {
            ...
            if (!this.arbolCadenas.contains(elemento)) {
                return false; 
            }
        }
